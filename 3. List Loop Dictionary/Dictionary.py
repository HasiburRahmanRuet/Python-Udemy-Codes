# -*- coding: utf-8 -*-
"""
Created on Thu Sep  3 16:42:11 2020

@author: Naznin
"""


# assignment='''NB: Assignment must be handwritten. IDmust be highlighted. Allstudent will submit theirassignment to
# the CRand CR will provide metheassignment inthelast classbefore two weeks of the final exam in
# ascending order (IDnumber).Iwill not accept any individually submittedassigment'''
...
sherlock1=sherlock.split(" ")


# for words in range(len(sherlock1)):
#     # new_words=list(sherlock1[words])
#     w=""
#     for i in sherlock1[words]:
#         if i.isalpha():
#             w+=i
#     sherlock1[words]=w        
...
sherloc_dict=dict(Counter(sherlock.lower()))
sherloc_dict_alpha={k:v for k,v in sherloc_dict.items() if k.isalpha()}
